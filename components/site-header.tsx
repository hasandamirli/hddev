    ...
    <header className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 p-1">
          ...
          <nav className="flex items-center space-x-2">
            <div className="hidden lg:flex items-center space-x-2">
              ...
              <Button
                ...
                size="icon"
                onClick={() =>
                  window.open("https://instagram.com/hdde.v", "_blank")
                }
              >
                <Icons.instagram
                  width="20"
      ...
      >
        <div className="flex flex-col h-full p-0 py-6 z-60">
          ...
          <p className="mt-auto flex flex-col space-y-4 leading-7 tracking-tight text-xs text-muted-foreground dark:text-gray-400  bg-white font-semibold dark:bg-black z-60"> Sosial Media</p>
            {/* <Button
              variant="ghost"
              onClick={() =>
                window.open("https://discord.gg/9PZpwYXA", "_blank")
